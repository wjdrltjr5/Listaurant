...
<script>
    ...
    function setCurrentPosition(){
        ...
        if (navigator.geolocation) {
            ...
            // geolocation을 사용할 수 없는 경우 기본 위치 설정
    ...
    function displayPlaces(places) {
        ...
        for ( let i=0; i<places.length; i++ ) {
            ...
            (function(marker, title) {
                ...
                kakao.maps.event.addListener(map, 'onclick', function() {
                    infowindow.close();
                });
    ...
    function displayInfowindow(marker, title) {
        let content = '<div style="padding:5px;z-index:1;">' + title + '</div>'
            + '<br>' + '<div style="padding:5px;z-index:1;">'
            + '<button style="padding:5px;z-index:1;" type="button" onclick="location.href=`list`">' + "상세 정보" + '</button>' + '</div>';
